...
% The lateset NWU-Beamer-Theme is modified by Xuankai Wang.
% The latex template file for NWU can be found here:
% https://github.com/starryious/NWU-latex-template
...
\author{\href{https://starryious.github.io/KamdenWang2003.github.io/}{王宣凯}}
\institute{\href{https://math.nwu.edu.cn/}{西北大学数学学院}}
\title{NWU Beamer Theme}
...
\begin{frame}{用Beamer很高大上？}
    ...
    % 除了alert，手动在里面插 \pause 也能达成“一页一单元”的效果
        ...
        \item 好多学校都有专属的Beamer主题，NWU也不能没有！
        \item 中文支持请选择 Xe\LaTeX{} 编译选项
        \item 原始项目的Overleaf地址位于 \url{https://www.overleaf.com/latex/templates/thu-beamer-theme/vwnqmzndvwyb}
        \item 本项目的GitHub地址位于 \url{https://github.com/starryious/NWU-latex-template}
...
\begin{frame}
    \begin{itemize}
        ...
        \item 各高校的Beamer模板最初来源自 \newline \url{https://www.latexstudio.net/archives/4051.html}
         \item 本模板在Weng的THU-Beamer-Theme基础上修改而成，感谢Weng同学！\href{https://trinkle23897.github.io/}{\color{blue}{戳这里，一起膜拜大神}}
    \end{itemize}
\end{frame}
...
\begin{frame}{作图}
    ...
    \begin{figure}[htpb]
        \centering
        \includegraphics[width=0.5\linewidth]{pic/nwu-logo.png}
        \caption{图片}
    \end{figure}
\end{frame}
...
\begin{frame}
    \begin{itemize}
        \item 一月：了解overleaf
        \item 二月：使用overleaf的各类模板进行编写
        \item 三月：制作NWU Beamer主题
        \item 五月：各类汇报
    \end{itemize}
\end{frame}
...
\begin{frame}{参考链接} % [allowframebreaks]
    \begin{itemize}
        ...
        \item 本项目的GitHub地址位于 \newline \url{https://github.com/starryious/NWU-latex-template}
    \end{itemize}
